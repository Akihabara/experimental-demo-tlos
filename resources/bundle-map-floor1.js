				...
				map:[
				 ...
				 mapActions:function() {
					if (!tilemaps.queststatus["beatenfirst"]) { // if the first 2 enemies are around
						if (!AkihabaraGamebox.getObject("foes","first1")&&!AkihabaraGamebox.getObject("foes","first2")) { // check them. If beaten...
							AkihabaraGamebox.getObject("walls","sidedoor").doOpen(); // Open the door...
					...
					if (!tilemaps.queststatus["beatensecond"]) { // if the first 2 enemies are around
						if (!AkihabaraGamebox.getObject("foes","second1")&&!AkihabaraGamebox.getObject("foes","second2")&&!AkihabaraGamebox.getObject("foes","second3")) { // check them. If beaten...
					...
					if (tilemaps.queststatus["floor2untrapped"]&&!tilemaps.queststatus["fl1smallkey"]&&!tilemaps.queststatus["_tmpsmallkey"]) { // With arrows
						if (!AkihabaraGamebox.getObject("foes","four1")&&!AkihabaraGamebox.getObject("foes","four2")&&!AkihabaraGamebox.getObject("foes","four3")&&!AkihabaraGamebox.getObject("foes","four4")) { // check them. If beaten...
